...
document.addEventListener('keydown', async function (e) {
    ...
    if (e.key === 'Enter') {
        console.log("Key:", e.key);
        // const res = await fetch("https://cactus.nci.nih.gov/cgi-bin/translate.tcl", {
        //     "headers": {
        //         "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
        //         "accept-language": "en-GB,en;q=0.9,ta-IN;q=0.8,ta;q=0.7,en-US;q=0.6,hi;q=0.5,fr;q=0.4",
        //         "cache-control": "max-age=0",
        //         "content-type": "multipart/form-data; boundary=----WebKitFormBoundaryqu2Z2EIsGAhsZM4W",
        ...
        //         "cookie": "ncbi_sid=8A1B036E180D86F1_0144SID; pmc.article.report=; _ga=GA1.2.9458787.1635833972; _ga=GA1.4.9458787.1635833972; _gid=GA1.4.985054364.1637338627; _gid=GA1.2.817108227.1637340095; _gat_GSA_ENOR0=1",
        //         "Referer": "https://cactus.nci.nih.gov/translate/",
        //         "Referrer-Policy": "strict-origin-when-cross-origin",
        //         "origin": "https://cactus.nci.nih.gov",
        //         "Access-Control-Allow-Origin": "*",
        //     },
        //     "body": `------WebKitFormBoundaryqu2Z2EIsGAhsZM4W\r\nContent-Disposition: form-data; name=\"smiles\"\r\n\r\n${moleculeInput}\r\n------WebKitFormBoundaryqu2Z2EIsGAhsZM4W\r\nContent-Disposition: form-data; name=\"format\"\r\n\r\npdb\r\n------WebKitFormBoundaryqu2Z2EIsGAhsZM4W\r\nContent-Disposition: form-data; name=\"astyle\"\r\n\r\nkekule\r\n------WebKitFormBoundaryqu2Z2EIsGAhsZM4W\r\nContent-Disposition: form-data; name=\"dim\"\r\n\r\n3D\r\n------WebKitFormBoundaryqu2Z2EIsGAhsZM4W\r\nContent-Disposition: form-data; name=\"file\"; filename=\"\"\r\nContent-Type: application/octet-stream\r\n\r\n\r\n------WebKitFormBoundaryqu2Z2EIsGAhsZM4W--\r\n`,
        //     "method": "POST"
        // });
        // console.log(res);
